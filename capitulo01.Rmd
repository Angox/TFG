...
-Paquete R estadistico Electoral-
...
Existen dos métodos basados en la cifra repartidora que son habitualmente utilizados, éstos son el método D`Hont y el Método Sainte-Laguë.
...
- Recuento de votos mediante matrices
  Se utiliza para los resultados una matriz en donde cada fila es el candidato como "contendiente" y en cada columna se sitúa el candidato como "oponente".
