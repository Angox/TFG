...
# Prueba fijo densidad, fijo votos, fijo n_partidos, distintos escaños
...
for (i in seq_len(n_escannos)) {
  ...
  votos <- votos # Fijo
  resul[[i]] <- asientos_dhondt(partidos, votos, n_escannos, couta_min = 0)$Escaños
}
...
# Prueba fijo densidad, fijo votos, var n_partidos, fijo escaños
...
for (i in seq_len(length(partidos))) {
  ...
  #votos <- votos[[i]] # Fijo
  resul[[i]] <- asientos_dhondt(partidos[[i]], votos[[i]], n_escannos, couta_min = 0)$Escaños
}
...
# Prueba var densidad, fijo votos, fijo n_partidos, fijo escaños
