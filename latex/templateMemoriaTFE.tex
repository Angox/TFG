$if(forprint)$
\documentclass[$if(fontsize)$$fontsize$,a4paper,$endif$$if(lang)$$babel-lang$,$endif$$if(papersize)$$papersize$paper,$endif$$for(classoption)$$classoption$$sep$,$endfor$]{$documentclass$}
...
<<<<<<< HEAD:latex/templateMemoriaTFE.tex
%\usepackage[dvipsnames]{xcolor}
%\usepackage[usenames,dvipsnames]{xcolor}  %new
=======
% \usepackage[dvipsnames]{xcolor}
>>>>>>> 7a9aff249ed42dc92c6b2fffdeba5b637e5551ed:tfe_principal.tex
\usepackage{pdfpages}
%\usepackage{natbib}
